                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a><i class="fa fa-laptop"></i> Vendas Online (Beta) <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="#">Faturamento Analítico</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a><i class="fa fa-bar-chart-o"></i> Gráficos <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="#">Alunos Ativos x Inativos</a></li>
                                            <li><a href="#">Receitas x Despesas</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a><i class="fa fa-laptop"></i> Vendas Online (Beta) <span class="fa fa-chevron-down"></span></a>
