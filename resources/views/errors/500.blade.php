        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center text-center">
              ...
              <h2>Houve uma falha na sua requisição.</h2>
              <p>Nós rastreamos esses erros automaticamente, mas se o problema persistir, não hesite em nos contatar. Enquanto isso, tente atualizar.
              </p>
            </div>
          </div>
        </div>
