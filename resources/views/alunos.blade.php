    ...
    <div class="row">
        <div class="col-md-12 col-sm-10 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" action="{{ route('report-alunos') }}" method="post">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($alunos as $aluno)
                                <tr>
                                    ...
                                    <th>{{$aluno->Status}}</th>
                                    <th>{{\Carbon\Carbon::parse($aluno->DataMatricula)->format("d/m/Y")}}</th>
                                    <th>{{$aluno->unidade->Nome}}</th>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
